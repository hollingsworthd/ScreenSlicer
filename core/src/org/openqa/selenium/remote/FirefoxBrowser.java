...
public class FirefoxBrowser implements Browser {
  ...
  private static Object exec(Browser browser, Executor action) {
    FirefoxBrowser myBrowser = (FirefoxBrowser) browser;
    Throwable throwable = null;
    for (int i = 0; i < RETRIES; i++) {
      try {
        Object ret = action.perform();
        try {
          synchronized (myBrowser.lock) {
            Set<String> handles = myBrowser.firefoxDriver.getWindowHandles();
            int num = -1;
            for (String cur : handles) {
              ++num;
              myBrowser.windowTranslator.put(cur, num);
            }
          }
        } catch (Throwable t) {
          Log.exception(t);
    ...
    throw new Browser.Retry(throwable);
  }

  private static List<WebElement> convert(Browser browser, List<WebElement> elements) {
    List<WebElement> myElements = new ArrayList<WebElement>();
    for (WebElement element : elements) {
      myElements.add(new MyElement(browser, (RemoteWebElement) element));
    }
    return myElements;
  }
  ...
  public FirefoxBrowser(Profile profile) {
  ...
  private static class MyElement implements WebElement, FindsByLinkText, FindsById, FindsByName,
    ...
    public MyElement(Browser browser, RemoteWebElement element) {
    ...
    public WebElement findElement(final By arg0) {
      return new MyElement(browser, (RemoteWebElement) exec(browser, new Executor() {
        @Override
        public Object perform() {
    ...
    public List<WebElement> findElements(final By arg0) {
      return convert(browser, (List<WebElement>) exec(browser, new Executor() {
        @Override
        public Object perform() {
    ...
    public String getAttribute(final String arg0) {
      return (String) exec(browser, new Executor() {
        @Override
        public Object perform() {
    ...
    public Point getLocation() {
      return (Point) exec(browser, new Executor() {
        @Override
        public Object perform() {
    ...
    public Dimension getSize() {
      return (Dimension) exec(browser, new Executor() {
        @Override
        public Object perform() {
    ...
    public boolean isDisplayed() {
      return (Boolean) exec(browser, new Executor() {
        @Override
        public Object perform() {
    ...
    public Coordinates getCoordinates() {
      return (Coordinates) exec(browser, new Executor() {
        @Override
        public Object perform() {
  ...
  private static class MyKeyboard extends RemoteKeyboard {
    ...
    public MyKeyboard(Browser browser, RemoteKeyboard keyboard) {
  ...
  private static class MyMouse extends RemoteMouse {
    ...
    public MyMouse(Browser browser, RemoteMouse mouse) {
    ...
    protected Map<String, Object> paramsFromCoordinates(final Coordinates where) {
      return (Map<String, Object>) exec(browser, new Executor() {
        @Override
        public Object perform() {
  ...
  public static class Profile extends FirefoxProfile {
    ...
    protected Reader onlyOverrideThisIfYouKnowWhatYouAreDoing() {
      URL resource = Resources.getResource(FirefoxBrowser.class, "/org/openqa/selenium/remote/browserdriver_prefs.json");
      try {
  ...
  private static class MyNav implements Navigation {
    ...
    public MyNav(Browser browser, Navigation nav) {
      this.browser = browser;
      this.nav = nav;
    }
  ...
  private static class MyLoc implements TargetLocator {
    ...
    public MyLoc(TargetLocator loc, Browser browser) {
      this.loc = loc;
      this.browser = browser;
    }
    ...
    @Override
    public Alert alert() {
      return (Alert) exec(browser, new Executor() {
        @Override
        public Object perform() {
          return loc.alert();
        }
      ...
      exec(browser, new Executor() {
        ...
        public Object perform() {
          try {
            ...
            return loc.window(((FirefoxBrowser) browser).translate(arg0));
          }
        }
      });
      return browser;
  ...
  private static class MyAction implements Action {
    ...
    public MyAction(Browser browser, Action action) {
      this.browser = browser;
      this.action = action;
    }
  ...
  private static class MyActions extends Actions {
    ...
    public MyActions(Browser browser) {
      super(browser);
      this.browser = browser;
    }

    public MyActions(Browser browser, Keyboard keyboard) {
      super(keyboard);
      this.browser = browser;
    }

    public MyActions(Browser browser, Keyboard keyboard, Mouse mouse) {
    ...
    @Override
    public Action build() {
      return new MyAction(browser, super.build());
    }
